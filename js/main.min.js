...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initHeroSlider.getBackgroundHeight)();
...
},{"./modules/form-validate/form":3,"./modules/init-nav-toggle":9,"./modules/init-video-player":10,"./modules/leaflet/init-leaflet":11,"./modules/modals/init-modals":12,"./modules/sliders/init-features-slider":14,"./modules/sliders/init-gallery-slider":15,"./modules/sliders/init-hero-slider":16,"./modules/sliders/init-instructors-slider":17,"./modules/sliders/init-reviews-slider":18,"./modules/sliders/init-tours-slider":19,"./utils/focus-lock":20,"./utils/ios-vh-fix":22,"./utils/scroll-lock":23}],2:[function(require,module,exports){
"use strict";
...
var initNavToggle = function initNavToggle() {
  ...
  var container = root.querySelector('.header__wrapper');
...
var button = document.querySelector('.hero__video').querySelector('.video__button');
...
exports.initSliderHero = exports.getBackgroundHeight = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderHero = document.querySelector('.hero__slider');
var sliderPagination = document.querySelector('.hero__pagination');
var initSliderHero = function initSliderHero() {
  if (sliderHero) {
    var classSliders = ['first', 'second', 'third'];
    ...
    swiper.on('transitionStart', function (e) {
      ...
      header.className = "header header--".concat(classSliders[e.realIndex], "-slide");
    });
  }
};
exports.initSliderHero = initSliderHero;
var getBackgroundHeight = function getBackgroundHeight() {
  if (document.querySelector('.header')) {
    var header = document.querySelector('.header');
    var hero = document.querySelector('.hero');
    var content = hero.querySelector('.hero__item-wrapper');
    var setHeight = function setHeight() {
      hero.style.marginTop = "-".concat(header.offsetHeight, "px");
      content.style.paddingTop = "".concat(header.offsetHeight, "px");
    };
    var target = new MutationObserver(setHeight);
