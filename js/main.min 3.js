...
var _initGallerySlider = require("./modules/sliders/init-gallery-slider");
var _initNavToggle = require("./modules/init-nav-toggle");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.addEventListener('resize', _initFeaturesSlider.destroySwiperIfNeeded);
    (0, _initGallerySlider.initSliderGallery)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/init-nav-toggle":9,"./modules/init-video-player":10,"./modules/leaflet/init-leaflet":11,"./modules/modals/init-modals":12,"./modules/sliders/get-slide-tabs":14,"./modules/sliders/init-features-slider":15,"./modules/sliders/init-gallery-slider":16,"./modules/sliders/init-hero-slider":17,"./modules/sliders/init-instructors-slider":18,"./modules/sliders/init-reviews-slider":19,"./modules/sliders/init-tours-slider":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";
...
var container = document.querySelector('.hero__video');
var cover = document.querySelector('.hero__video').querySelector('picture');
var button = document.querySelector('.hero__video').querySelector('.hero__video-button');
...
var initLeaflet = function initLeaflet() {
  ...
  }).setView([55.774906445034176, 37.632641498705205], 14);
  ...
  L.marker([55.774906445034176, 37.632641498705205], {
    icon: myIcon
  }).addTo(map);
};
...
exports.initSliderFeatures = exports.destroySwiperIfNeeded = void 0;
...
var destroySwiperIfNeeded = function destroySwiperIfNeeded() {
...
exports.destroySwiperIfNeeded = destroySwiperIfNeeded;
...
var sliderGallery = document.querySelector('.gallery__swiper');
var buttonNext = document.querySelector('.gallery__button--next');
var buttonPrev = document.querySelector('.gallery__button--prev');
...
exports.initSliderGallery = initSliderGallery;
...
var initSliderHero = function initSliderHero() {
  if (sliderHero) {
    var swiper = new _swiper.default(sliderHero, {
      pagination: {
        el: sliderPagination,
        clickable: true
      },
...
exports.initSliderInstructors = void 0;
var sliderInstructors = document.querySelector('.instructors__swiper');
var buttonNext = document.querySelector('.instructors__button--next');
var buttonPrev = document.querySelector('.instructors__button--prev');
var initSliderInstructors = function initSliderInstructors() {
...
var sliderTours = document.querySelector('.tours__swiper');
var buttonNext = document.querySelector('.tours__button--next');
var buttonPrev = document.querySelector('.tours__button--prev');
var initSliderTours = function initSliderTours() {
  if (sliderTours) {
    // eslint-disable-next-line
